...
const Impressum = props => {
	...
	`)
	const title = data.allContentfulSeiteImpressum.edges[0].node.title
	const introTextJSON = JSON.parse(data.allContentfulSeiteImpressum.edges[0].node.introText.raw)
	const contentTextJSON = JSON.parse(data.allContentfulSeiteImpressum.edges[0].node.contentText.raw)
